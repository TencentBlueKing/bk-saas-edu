...
const emptyViewfgkcdfaf = () => import(/* webpackChunkName: 'emptyView' */'@/views/emptyView/bkindex')
const home = () => import(/* webpackChunkName: 'home' */'@/views/emptyView/home.vue')
...
const routes = [
    {
        ...
        children: [
            {
                path: '',
                name: 'emptyViewfgkcdfaf',
                component: emptyViewfgkcdfaf,
                children: [
